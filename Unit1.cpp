...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
        Application->MessageBox("Witaj w grze PingPong.\n\n"
                    ...
                    "Kiedy odbijesz pi≥kÍ na úrodku paletki, wÛwczas zmienisz jej kπt odbicia i pi≥ka przyspieszy, pojawi siÍ specyficzny düwiÍk.\n"
                    "Im d≥uøej odbijasz tym pi≥ka szybciej siÍ przemieszcza.\n"
                    "Moøesz dowolnie zmieniaÊ pole gry.\n\n"
		    "Mi≥ej zabawy!","Ping-Pong", MB_OK | MB_ICONINFORMATION);
        startNewGame();
